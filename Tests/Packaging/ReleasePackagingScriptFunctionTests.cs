...
{
    private const string Version = "8.10.9";
    ...
    public void PublishedPackage_ValidatesCoreVersionCommitAssemblyAndHashes()
    {
        ...
        Assert.Contains($"8.10.9.0|8.10.9+{fixture.Commit}|CrossETF.Terminal.UiShell.Reference", output, StringComparison.OrdinalIgnoreCase);
