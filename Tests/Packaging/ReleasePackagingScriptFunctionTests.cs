...
{
    private const string Version = "8.10.5";
    ...
    public void PublishedPackage_ValidatesCoreVersionCommitAssemblyAndHashes()
    {
        ...
        Assert.Contains($"8.10.5.0|8.10.5+{fixture.Commit}|CrossETF.Terminal.UiShell.Reference", output, StringComparison.OrdinalIgnoreCase);
