...
{
    private const string Version = "8.10.3";
    ...
    public void PublishedPackage_ValidatesCoreVersionCommitAssemblyAndHashes()
    {
        ...
        Assert.Contains($"8.10.3.0|8.10.3+{fixture.Commit}|CrossETF.Terminal.UiShell.Reference", output, StringComparison.OrdinalIgnoreCase);
