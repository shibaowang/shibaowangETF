...
{
    private const string Version = "8.10.6";
    ...
    public void PublishedPackage_ValidatesCoreVersionCommitAssemblyAndHashes()
    {
        ...
        Assert.Contains($"8.10.6.0|8.10.6+{fixture.Commit}|CrossETF.Terminal.UiShell.Reference", output, StringComparison.OrdinalIgnoreCase);
