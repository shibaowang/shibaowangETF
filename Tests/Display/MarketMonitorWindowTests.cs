...
public sealed class MarketMonitorWindowTests
{
    ...
    public static IEnumerable<object[]> VersionFragments()
    {
        string[] fragments =
        {
            ...
            "<AssemblyVersion>8.10.9.0</AssemblyVersion>",
            "<FileVersion>8.10.9.0</FileVersion>",
            "<InformationalVersion>8.10.9</InformationalVersion>"
        };
    ...
    public void VersionContract_PreservesAssemblyNameAndExistingReader()
    {
        ...
        Assert.Equal("V8.10.9", MainWindow.ResolveDisplayVersion());
